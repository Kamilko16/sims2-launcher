Public Class MyListBox
    ...
    Public Sub AddItem(ByVal name As String)
        Dim radio As New MyRadioButton
        radio.Radio_Value.Text = name
        radio.Location = New Point(0, allitems * 15)
        Radio_Internal_Container.Controls.Add(radio)
        allitems += 1
    End Sub
